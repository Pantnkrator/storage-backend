...
public class FileType implements Serializable {
    ...
    public FileType createdBy(String createdBy) {
    ...
    public FileType lastModifiedBy(String lastModifiedBy) {
    ...
    public FileType lastModifiedDate(Instant lastModifiedDate) {
